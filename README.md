...
Five benchmark **operating-system desktop** personal-site prototypes plus **Win98×XP** and **Classic Windows 98** iterations for [Mikail](https://github.com/MikailR), each generated by a different local CLI/model against the same creative brief.
...
Built as a multi-model bakeoff on a box-local CLI stack (no CloudAgent for generation).

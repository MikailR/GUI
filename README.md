...
Five complete **operating-system desktop** personal-site prototypes for [Mikail](https://github.com/MikailR), each generated by a different local CLI/model against the same creative brief.

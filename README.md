...
Five benchmark **operating-system desktop** personal-site prototypes plus a **Win98×XP** iteration for [Mikail](https://github.com/MikailR), each generated by a different local CLI/model against the same creative brief.
